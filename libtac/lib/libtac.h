...
#define TAC_PLUS_SRC_IP_LENGTH 20 /* should be enough to cover XXX.XXX.XXX.XXX/XX */
...
extern int tac_connect_single(const struct addrinfo *, const char *, const char *, struct sockaddr_in *,
                              int);
